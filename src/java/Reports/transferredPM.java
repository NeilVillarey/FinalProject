...
public class transferredPM {
    ...
    public void transferredPMReport(String name, String role, String payment_method, String plan, String amount, ResultSet result) {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream("C:\\Users\\" + System.getProperty("user.name")
                    + "\\Desktop\\" + username + "_" + dtf.format(now) + "Tranferred Paid Membership.pdf"));
            ...
            Paragraph heading = new Paragraph("Customers from guests that transferred to paid membership", header);
