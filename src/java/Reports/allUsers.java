...
public class allUsers {
    ...
    public void allUsersReport(String name, String role, ResultSet result) {
        try {
            this.username = name;
            this.role = role;
            ...
            System.out.println("C:\\Users\\" + System.getProperty("user.name")
                    + "\\Desktop\\");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream("C:\\Users\\user\\Downloads\\zzz.pdf" ));
            ...
            Paragraph heading = new Paragraph("All Users", header);
