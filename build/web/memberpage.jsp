...
<html lang="en">
  <head>
    <title>EcoHero - Our Products</title>
    <meta charset="utf-8">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="guestpage.jsp" class="nav-link">Home</a></li>
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="<%=request.getContextPath()%>/ViewServlet">Cart</a></span> <span>Shop</span></p>
						        		...
						        		<div class="menu-entry">
						    					...
						    					<div class="text text-center pt-4">
						    						...
						    						<p><form action="AddServlet" method="post">
                                                                                                    <input type="hidden" name="PRODUCT"  value="Eco Bag">
                                                                                                    <input type="hidden" name="id"  value="EB">
						        		...
						        		<div class="menu-entry">
						    					...
						    					<div class="text text-center pt-4">
						    						<p><form action="AddServlet" method="post">
                                                                                                    ...
                                                                                                    <input name="PRICE" type="hidden" size="20" value=1233>
                                                                                                <button type="submit" class="btn btn-primary btn-outline-primary">Add to Cart</button>
                                                                                                </form></p>
						    					</div>
						    				</div>
